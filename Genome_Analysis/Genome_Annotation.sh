...
/home/Softwares/maker/bin/maker -c 40 maker_opts.ctl maker_exe.ctl maker_bopts.ctl maker_evm.ctl -fix_nucleotides -genome Final_EC_assembly_masked.fasta -RM_off -TMP ./tmp
...
#tRNA prediction
tRNAscan-SE Final_EC_assembly.fasta -o EC_tRNA_result -f EC_secondary -m EC_tRNA_stats --thread 20
#rRNA prediction
barrnap Final_EC_assembly.fasta --kingdom euk --quiet --threads 20 --outseq EC_rRNA_Out
#Homology-based miRNA identification (using MirGeneDB database)
makeblastdb -in Final_EC_assembly.fasta -dbtype nucl
blastn -query mirGene_precursors.fasta -db Final_EC_assembly.fasta -out mirGeneDB_EC_blastn -evalue 0.000000001 -outfmt 6 -qcov_hsp_perc 90 -perc_identity 90 -num_threads 20
