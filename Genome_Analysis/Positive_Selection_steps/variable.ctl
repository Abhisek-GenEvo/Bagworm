seqfile  = sequence.phy   * sequence data file name
treefile = raxml_bipartition_reduced.txt         * tree structure file name
outfile  = sequence_variable.txt  * main result file name
